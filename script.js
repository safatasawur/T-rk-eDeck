...
const categories = {
  animals: [
    { word: "kedi", meaning: "cat", image: "imgs/animals/cat.png" },
    { word: "köpek", meaning: "dog", image: "imgs/animals/dog.png" },
    { word: "kuş", meaning: "bird", image: "imgs/animals/bird.png" },
    { word: "balık", meaning: "fish", image: "imgs/animals/fish.png" },
    { word: "at", meaning: "horse", image: "imgs/animals/horse.png" },
    { word: "inek", meaning: "cow", image: "imgs/animals/cow.png" },
    { word: "koyun", meaning: "sheep", image: "imgs/animals/sheep.png" },
    { word: "tavşan", meaning: "rabbit", image: "imgs/animals/rabbit.png" },
    { word: "aslan", meaning: "lion", image: "imgs/animals/lion.png" },
    { word: "kaplumbağa", meaning: "turtle", image: "imgs/animals/turtle.png" }
  ],
  fruits: [
    { word: "elma", meaning: "apple", image: "imgs/apple.jpeg" },
    { word: "muz", meaning: "banana", image: "imgs/fruits/banana.png" },
    { word: "çilek", meaning: "strawberry", image: "imgs/fruits/strawberry.png" },
    { word: "portakal", meaning: "orange", image: "imgs/fruits/orange.png" },
    { word: "kiraz", meaning: "cherry", image: "imgs/fruits/cherry.png" },
    { word: "üzüm", meaning: "grape", image: "imgs/fruits/grape.png" },
    { word: "karpuz", meaning: "watermelon", image: "imgs/fruits/waterelon.png" },
    { word: "şeftali", meaning: "peach", image: "imgs/fruits/peach.png" },
    { word: "armut", meaning: "pear", image: "imgs/fruits/pear.png" },
    { word: "mandalina", meaning: "tangerine", image: "imgs/fruits/tangerine.png" }
  ],
  food: [
    { word: "ekmek", meaning: "bread", image: "imgs/food/bread.png" },
    { word: "peynir", meaning: "cheese", image: "imgs/food/cheese.png" },
    { word: "et", meaning: "meat", image: "imgs/food/meat.png" },
    { word: "pilav", meaning: "rice", image: "imgs/food/rice.png" },
    { word: "çorba", meaning: "soup", image: "imgs/food/soup.png" },
    { word: "yumurta", meaning: "egg", image: "imgs/food/egg.png" },
    { word: "yoğurt", meaning: "yogurt", image: "imgs/food/yogurt.png" },
    { word: "balık", meaning: "fish", image: "imgs/food/fishfood.png" },
    { word: "tavuk", meaning: "chicken", image: "imgs/food/chceken.png" },
    { word: "makarna", meaning: "pasta", image: "imgs/food/pasta.png" }
  ],
  colors: [
    { word: "mavi", meaning: "blue", image: "imgs/colours/blue.png" },
    { word: "kırmızı", meaning: "red", image: "imgs/colours/red.png" },
    { word: "yeşil", meaning: "green", image: "imgs/colours/green.png" },
    { word: "sarı", meaning: "yellow", image: "imgs/colours/yellow.png" },
    { word: "siyah", meaning: "black", image: "imgs/colours/black.png" },
    { word: "beyaz", meaning: "white", image: "imgs/colours/white.png" },
    { word: "turuncu", meaning: "orange", image: "imgs/colours/ch.png" },
    { word: "mor", meaning: "purple", image: "imgs/colours/purple.png" },
    { word: "pembe", meaning: "pink", image: "imgs/colours/pink.png" },
    { word: "gri", meaning: "gray", image: "imgs/colours/gray.png" }
  ],
  nouns: [
